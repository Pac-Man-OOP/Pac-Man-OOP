...
public class FreezePickupEntity extends Entity {

    public FreezePickupEntity(String id, float x, float y, float size) {
        super(id);
        setX(x);
        setY(y);
        setWidth(size);
    ...
    public void render(OutputManager outputManager) {
        ...
        outputManager.draw(LingoSprites.freezePickup(), drawX, drawY, drawWidth, drawHeight);
    }
}
